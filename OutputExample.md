...
Few comments about the example below:
  * the logs are coming from third actor : MY\_B2B\_APP
  * the call is initiated by the PSTN\_GATEWAY
  * it goes through the SIP\_ROUTING\_PROXY, but details are not seen in the logs we are monitoring.
  * MY\_B2B\_APP bridges the caller with an IVR\_PLATFORM (via a LOAD\_BALANCER\_VIP)
  * a while after it adds a third dialog by requesting a redirect on a PSTN\_ROUTER application
  * finally it requires a fourth dialog to transfer back the caller to a callee (using the same PSTN\_GATEWAY).
  * the matching of the 4 dialogs is done according to a known common token in the from and to tags managed by the B2B (in that example **s1460**) . The parser configured in sip-viewer must be aware of this contact.

```
1 sessions displayed 

***** #1460 Mon, 22 Nov 2010 08:30:18 188************************************************************
#   Time (ms)   PSTN_GATEWAY:5060          SIP_ROUTING_PROXY:12716          MY_B2B_APP:12276                 LOAD_BALANCER_VIP                IVR_PLATFORM               PSTN_ROUTER:12786
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
From: "my-caller" <sip:4188561561@10.92.10.80:5060;user=phone>;tag=-45026-28a2195-3bc1429d-28a2195
...
Remote-Party-ID: "my-caller"<sip:4188561561@10.92.10.80;user=phone>; party=calling; privacy=off; screen=yes
...
P-Asserted-Identity: "my-caller" <sip:4188561561@10.92.10.80;user=phone>
Max-Forwards: 69
...
CSeq: 2 INVITE
From: "my-caller" <sip:4188561561@10.92.10.80>;tag=s1460-8345703489627602869
Max-Forwards: 70
BillingID: a626b0d8500a5c0a13c428a2195eb932e94a1e8c7d3c4deaf0-0209-7451
Remote-Party-ID: "my-caller" <sip:4188561561@10.92.10.80>;party=calling;screen=yes;privacy=off
To: <sip:5143901033@10.92.244.52:5060;user=phone>
Content-Type: application/sdp
...
P-Asserted-Identity: "my-caller" <sip:4188561561@10.92.10.80>
Content-Length: 187
...
To: "my-caller" <sip:4188561561@10.92.10.80>;tag=s1460-8345703489627602869
Contact: <sip:nvp@10.92.244.41:5062>;transport=udp
Call-ID: s1460-8345703489627602869@142.125.224.36
CSeq: 1 REFER
...
CSeq: 2 INVITE
From: "my-caller" <sip:4188561561@10.92.10.80>;tag=s1460-8579646444826495654
...
CSeq: 2 INVITE
From: "my-caller" <sip:4188561561@10.92.10.80>;tag=s1460-6240023739594637478
Max-Forwards: 70
Remote-Party-ID: "my-caller" <sip:4188561561@10.92.10.80>;party=calling;screen=yes;privacy=off
To: <sip:4186437880@10.92.244.52:12786>
Content-Type: application/sdp
...
To: "my-caller" <sip:4188561561@10.92.10.80:5060;user=phone>;tag=-45026-28a2195-3bc1429d-28a2195
Call-ID: a626b0d8500a5c0a13c428a2195eb932e94a1e8c7d3c4deaf0-0209-7451
Max-Forwards: 70
Contact: <sip:142.125.224.36:12276;transport=udp>
Content-Type: application/sdp
